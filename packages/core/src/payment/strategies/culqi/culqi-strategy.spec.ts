...
import { createSubStrategyRegistry } from './create-culqi-sub-strategy-registry';
import { PaymentResumer } from './culqi-payment-resumer';
import { CULQIStrategy } from './culqi-strategy';
import { SubStrategyRegistry } from './culqi-sub-strategy-registry';
import { createStepHandler } from './step-handler';

describe('CULQIStrategy', () => {
    ...
    describe('when initialized with a valid CULQI payment method', () => {
        describe('#initialize', () => {
            it('does not throw an error', async () => {
                const strategy = new CULQIStrategy(
                    store,
                    orderActionCreator,
                    subStrategyRegistry,
                    paymentResumer,
        ...
        describe('when the bigpayBaseUrl is correctly set within store config', () => {
            ...
            describe('when there is an existing order with a matching CULQI Payment', () => {
                describe('#finalize', () => {
            ...
            describe('when there is an existing order, but without a matching CULQI Payment', () => {
                describe('#finalize', () => {
    ...
    describe('when initialized with a not yet supported CULQI payment method', () => {
        describe('#initialize', () => {
    ...
    describe('when initialized with a non CULQI payment method', () => {
        describe('#initialize', () => {
            it('throws a NotInitializedError error', async () => {
                const strategy = new CULQIStrategy(
                    store,
