...
import { getCULQIMethod } from './get-culqi-payment-method';
import { CULQICompletedPayments } from './culqi-completed-payments';
...
export class CULQIStrategy implements PaymentStrategy {
    private _subStrategy?: SubStrategy;
    private _completedPayments: CULQICompletedPayments;
    ...
    constructor(
        ...
        this._completedPayments = new CULQICompletedPayments(browserStorage);
    }
    ...
    async initialize(options?: PaymentInitializeOptions): Promise<InternalCheckoutSelectors> {
        ...
        const paymentMethod = getCULQIMethod(this._store, options.methodId);
